  ...
  return (
    <div className="about">
        <div className="about-left">
            <img src={vid} alt=""className='about-img' />
        ...
        <div className="about-right">
           ...
           education.
            ...
            <p>
            With a focus innovation, hands-on learning, and personalized
            mentorship, our programs prepare aspiring educatos to make a 
            meaningful impact in classroom, schools, and communities.
            </p>
            <p>
            Whether you aspire to became a teacher, adminstrator,
            counslor, or educational leader, our diverse range of programs 
